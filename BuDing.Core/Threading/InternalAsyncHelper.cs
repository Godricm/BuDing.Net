...
namespace BuDing.Threading
{
    public static class InternalAsyncHelper
    {
        ...
        /// 异步方法调用
        /// </summary>
        /// <param name="actualReturnValue">异步方法</param>
        /// <param name="finalAction">finally 方法</param>
        /// <returns></returns>
            ...
            Action<Exception> finalAction)
        {
            return typeof(InternalAsyncHelper)
                ...
                ?.MakeGenericMethod(taskReturnType).Invoke(null, new object[] {actualReturnValue, finalAction});
        }
