...
namespace BuDing.Ioc.Dapper.Repository.UnitOfWork.Containers
{
    internal sealed class SqlDialectContainer
    {
        ...
        internal bool TryEntityIsFroozenOrDialogueIsCorrect<TEntity>() where TEntity : class
        {
            bool isFroozen;
            return _entityIsFroozenOrDialogueCorrect.TryGetValue(typeof(TEntity), out isFroozen) && isFroozen;
        }

        internal void AddEntityFroozenOrDialogueState<TEntity>(bool state) where TEntity : class
        {
